...
<body style="background-color:#0F0E0E;">
    ...
    <div class="main-div">
        ...
        <div class="data-content">
            <div class="heads">
                <span style="color:white;font-size:1.7rem;">Newland Announcements Database</span>
                <a href="/addannform"><button class="btn btn-success">Add Announcement</button></a>
            </div>
            ...
            <div style="width:80%;height:5%;display:flex;flex-direction:row;">{{ $ann_data->links() }}</div>
