        ...
        <div class="main-content">
            ...
            <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data" style="width:100%;">
                ...
                <div style="display:flex;flex-direction:column;width:100%;">
                    ...
                    <x-text-input id="name" class="tfield" type="text" name="name" :value="old('name')" required
                        autofocus />
                    @if ($errors->has('name'))
                ...
                <div style="display:flex;flex-direction:column;width:100%;">
                    ...
                    <x-text-input id="age" class="tfield" style="width:10%;" type="text" name="age"
                        required autofocus />
                </div>
                <div style="display:flex;flex-direction:column;width:100%;">
                    <x-input-label for="gender" :value="__('Gender')" class="textlabel" />

                    <x-text-input id="gender" class="tfield" style="width:20%;" type="text" name="gender"
                        required autofocus />
                </div>
                <div style="display:flex;flex-direction:column;width:100%;">
    ...
    <div class="div-block" id="div3">
        ...
        <div class="main-content">
            ...
            <div style="display:flex;flex-direction:column;width:100%;">
                ...
                <input type="file" id="exampleInputPassword1" name="pfp"
    ...
    <div class="div-block" id="div4">
        ...
        <div class="main-content">
            ...
            <div style="display:flex;flex-direction:column;width:100%;">
                ...
                <x-text-input id="password" class="tfield" type="password" name="password" required
                    autocomplete="new-password" />
            </div>
            <div style="display:flex;flex-direction:column;width:100%;">
                <x-input-label for="password_confirmation" :value="__('Confirm Password')" class="textlabel" />

                <x-text-input id="password_confirmation" class="tfield" type="password" name="password_confirmation"
                    required />
