...
<head>
    ...
    <title>Edit Data | Newland University</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body style="background-color: #252525;">
    <div class="div-block" id="div1">
        ...
        <div class="main-content">
            ...
            <form method="POST" action="/edit/{{$users['id']}}" enctype="multipart/form-data" style="width:100%;">
                @csrf
                <div style="display:flex;flex-direction:column;width:100%;">
                    <x-input-label for="name" :value="__('Name')" class="textlabel" />
                    <x-text-input id="name" class="tfield" type="hidden" name="name" value="{{$users['id']}}" required autofocus />
                    <x-text-input id="name" class="tfield" type="text" name="name" value="{{$users['name']}}" required autofocus />
                </div>
                <div style="display:flex;flex-direction:column;width:100%;">
                    <x-input-label for="age" :value="__('Age')" class="textlabel" />

                    <x-text-input id="age" class="tfield" style="width:10%;" value="{{$users['age']}}" type="text" name="age" required autofocus />
                </div>
                <div style="display:flex;flex-direction:column;width:100%;">
                    <x-input-label for="gender" :value="__('Gender')" class="textlabel" />

                    <x-text-input id="gender" class="tfield" style="width:20%;" value="{{$users['gender']}}" type="text" name="gender" required autofocus />
                </div>
                <div style="display:flex;flex-direction:column;width:100%;">
                    <x-input-label for="bloodgroup" :value="__('Blood Group')" class="textlabel" />

                    <x-text-input id="bloodgroup" class="tfield" type="text" value="{{$users['bloodgroup']}}" name="bloodgroup" required autofocus />
    ...
    <div class="div-block" id="div2">
        ...
        <div class="main-content">
            ...
            <div style="display:flex;flex-direction:column;width:100%;">
                ...
                <x-text-input id="mobile" class="tfield" type="text" value="{{$users['mobile']}}" name="mobile" required autofocus />
            </div>
            <div style="display:flex;flex-direction:column;width:100%;">
                <x-input-label for="email" :value="__('Email')" class="textlabel" />

                <x-text-input id="email" class="tfield" type="email" name="email" value="{{$users['email']}}" required />
            </div>
            <div>
                <x-input-label for="last_school" :value="__('Last School')" class="textlabel" />

                <x-text-input id="last__school" class="tfield" type="text" value="{{$users['last_school']}}" name="last_school" required autofocus />
            </div>
    ...
    <div class="div-block" id="div3">
        ...
        <div class="main-content">
            ...
            <div style="display:flex;flex-direction:column;width:100%;">
                ...
                <x-text-input id="sem" class="tfield" type="text" value="{{$users['sem']}}" name="sem" required autofocus />

            </div>
            <div style="display:flex;flex-direction:column;width:100%;">
                <x-input-label for="div" :value="__('Division')" class="textlabel" />

                <x-text-input id="div" class="tfield" type="text" value="{{$users['div']}}" name="div" required autofocus />
            </div>

            <div style="display:flex;flex-direction:column;width:100%;">
                <label for="pfp" class="textlabel">Kindly Upload Your Picture</label>
                <input type="file" id="exampleInputPassword1" name="pfp" value="{{$users['pfp']}}" style="color:white;margin-top:10px;margin-bottom:10px;">
            </div>
    ...
    <div class="div-block" id="div4">
        ...
        <div class="main-content">
            ...
            <div style="display:flex;flex-direction:column;width:100%;">
                ...
                <x-text-input id="password" class="tfield" type="password" value="{{$users['password']}}" name="password" required autocomplete="new-password" />
            </div>
            <div style="display:flex;flex-direction:column;width:100%;">
                <x-input-label for="password_confirmation" :value="__('Confirm Password')" class="textlabel" />

                <x-text-input id="password_confirmation" class="tfield" type="password" value="{{$users['password_confirmation']}}" name="password_confirmation" required />
