...
<body style="background-color:#0F0E0E;">
    ...
    <div class="main-div">
        ...
        <div class="data-content">
                    ...
                    <div class="col" style="color:#2DE2BE;">
                        <div class="card h-100 card-hover" style="background-color:#151515;">
                            <div class="card-body">
                                ...
                                <p class="card-text">{{$cd->email}}</p>
                                <p class="card-text" style="border-bottom:1px dashed white;">{{$cd->mobile}}</p>
                                <p class="card-text">{{$cd->cmsg}}</p>
                            </div>
                        </div>
                    </div>
                  @endforeach
            ...
            <div style="width:80%;height:5%;display:flex;flex-direction:row;margin-left:14px;margin-top:15px;">{{ $contact_data->links() }}</div>
        </div>
